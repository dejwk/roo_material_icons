...
const RleImage4bppxPolarized<Alpha4, PrgMemResource>& ic_filled_24_home_sensor_window() {
...
const RleImage4bppxPolarized<Alpha4, PrgMemResource>& ic_filled_24_home_sensor_door() {
  static RleImage4bppxPolarized<Alpha4, PrgMemResource> value(
